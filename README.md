...
## The simplest hyperstatic 2D system with uniform members length

Simplest: minmal number of nodes, no double edges (bars/columns/members).
TODO

## The simplest hyperstatic 3D system with uniform members length
